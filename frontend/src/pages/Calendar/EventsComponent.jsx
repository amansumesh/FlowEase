              ...
              {selectedTasks.map((task) => (
                ...
                >
                  <div className="flex items-start gap-3 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 mt-2 text-xs text-gray-500">
                        ...
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${task.completed ? 'bg-green-100 text-green-700' :
                  ...
                  <button
                    ...
                    className={`ml-3 p-2 rounded-full transition-colors ${task.completed
